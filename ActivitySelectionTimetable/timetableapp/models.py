...
class Classroom(models.Model):
    ...
    classroom_type = models.CharField(max_length=2000, null=True)
    def __str__(self):
...
class Class(models.Model):
    ...
    week_day = models.CharField(max_length=2000)
...
class Activity(models.Model):
    ...
    activity_type = models.CharField(max_length=2000, null=True)
